...
latex_documents = [
    (master_doc, 'caterpillar.tex', 'caterpillar Documentation',
     'EPFL LIS', 'manual'),
]
...
man_pages = [
    (master_doc, 'caterpillar', 'caterpillar Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'caterpillar', 'caterpillar Documentation',
     author, 'caterpillar', 'One line description of project.',
     'Miscellaneous'),
]
...
breathe_projects = {"caterpillar": "doxyxml/xml"}
