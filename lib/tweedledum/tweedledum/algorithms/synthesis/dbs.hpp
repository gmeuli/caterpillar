...
auto inline decompose(std::vector<uint32_t>& permutation, uint8_t var)
{
...
auto inline control_function_abs(uint32_t num_vars, std::vector<uint32_t> const& permutation)
{
